...
**Hello-Rails-React**  This is a rails-react App with a backend and a frontend which consumes the endpoints.
...
```sh
  git clone https://github.com/Bleu-Yves-Sopoude/hello-rails-react.git
```
